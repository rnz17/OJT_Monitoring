        ...
        <!-- header -->
            <form method="GET" action="{{ route('admin.landing') }}">
                <div class="flex justify-between items-center mb-4">
                    ...
                    <input id="search" type="text" name="search" value="{{ old('search', $search) }}" placeholder="Search for Student ID, Name, Section etc..." class="border border-pink-300 rounded px-4 py-2 w-1/3">

                    <select id="program" name="program" class="border border-pink-300 rounded px-12 py-2 mr-4">
                    ...
                    <select id="section" name="section" class="border border-pink-300 rounded px-12 py-2">
